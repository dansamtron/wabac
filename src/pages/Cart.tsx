    ...
    return (
      <div className="min-h-[60vh] bg-[#FFFBF5] grid place-items-center px-4 py-10">
        <div className="max-w-md text-center rounded-[22px] bg-white border border-[#F3E6D3] p-8">
          ...
          <div className="mt-4 rounded-2xl bg-[#FFF1DA] border border-[#F3E6D3] p-3 text-xs leading-5">Price and stock were checked at order time. Platform fee {success.paid ? "has been split" : "will be split on payment"}. WhatsApp AI uses the same tools.</div>
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF5]">
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="text-sm text-[#6b6b6b]">{items.length} items • Pay with Paystack or place Pay on delivery</p>
          ...
          <div className="space-y-4">
            <div className="rounded-[22px] bg-white border border-[#F3E6D3] p-6 h-fit">
              ...
              <div className="mt-5 space-y-3">
                ...
                <p className="text-xs text-[#9a9a9a] leading-5">Paystack uses test mode if no VITE_PAYSTACK_PUBLIC_KEY. Transaction is recorded with platform fee split. Seller sees Paid in Revenue after verification.</p>
              </div>
