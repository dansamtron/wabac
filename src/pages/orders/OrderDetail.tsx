...
import { ArrowLeft, Package, User, MapPin, Phone, Clock, CreditCard, Truck } from "lucide-react"
        ...
        <div className="mt-6 grid lg:grid-cols-[1.2fr_0.8fr] gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white border border-[#F3E6D3] p-4">
              ...
              {order.paymentStatus === "Pending" && <div className="mt-3 rounded-xl bg-[#FFF1DA] border border-[#F3E6D3] p-3 text-xs leading-5">Payment pending. Phase 7 will integrate Paystack. For now mark as Paid when confirmed outside.</div>}
            </div>
